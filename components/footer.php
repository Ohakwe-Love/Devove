...
<footer>
    <div class="container">
        <div class="footer-grid">
            <div class="footer-brand">
                ...
                <p>
                    ...
                    Webelieve in transparent, collaborative development.
                </p>
            </div>
            ...
            <div class="footer-column">
                ...
                <div class="cta-section">
                    <div class="board">
                        ...
                        <div class="key-position">
                            <a aria-label="Bluesky" class="key" data-key="Bluesky"
                        ...
                        <div class="key-position">
                            <a aria-label="Facebook" class="key" data-key="Facebook" target="_blank" href=""> 
                                <svg
                        ...
                        <div class="key-position">
                            <a aria-label="Instagram" class="key" data-key="Instagram" target="_blank" href=""> 
                                <svg
                        ...
                        <div class="key-position">
                            <a aria-label="Twitter" class="key" data-key="Twitter" target="_blank" href=""> 
                                <svg
        ...
        <div class="footer-bottom">
            <div class="copyright">&copy; <span class="year"><?php echo date('Y'); ?></span> Devove. All rights reserved.</div>
